...
export const comoFunciona = {
  label: "Como funciona",
  title: "Três passos, e o terceiro é seu.",
  ...
  passos: [
    ...
    {
      numero: "02",
      title: "A gente constrói as máquinas",
      body: "Em cima do seu sistema, montamos uma máquina para cada tipo de material: páginas, apresentações, mídia social, vídeo. Cada uma é uma linha de montagem, com etapas e conferência, não um botão mágico.",
      detail: {
