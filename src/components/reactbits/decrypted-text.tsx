...
export default function DecryptedText({
  ...
  // Reinicialização quando `text` ou `animateOn` mudam. É o padrão do React de
  // ajustar estado durante o render comparando com o valor anterior — num
  // efeito, isso dispararia um render em cascata a cada troca de prop.
