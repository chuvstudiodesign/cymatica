 ...
 * verdade acontece em /orcamento, que é onde o escopo é definido.
 */
export function BudgetTeaser() {
  ...
  function submit(event: React.FormEvent) {
    ...
    router.push(`${BASE}/orcamento${query}`)
  }
