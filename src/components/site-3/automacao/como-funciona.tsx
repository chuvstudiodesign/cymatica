...
import { comoFunciona, type Passo } from "@/lib/site-3/automacao"
    ...
    <li data-reveal="" className="border-t border-border pt-10 first:border-t-0 first:pt-0">
      <div className="grid gap-8 lg:grid-cols-12 lg:gap-12">
        <div className="lg:col-span-4">
          <span className="site-label text-muted-foreground">{passo.numero}</span>
...
export function AutomacaoComoFunciona() {
  return (
