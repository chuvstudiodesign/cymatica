...
import { SiteHeader } from "@/components/site-2/site-header"
import { SiteFooter } from "@/components/site-2/site-footer"
import { SmoothScrollProvider } from "@/components/site-2/smooth-scroll-provider"
import "./site-2.css"
 ...
 */
export default function SiteLayout({ children }: LayoutProps<"/site-2">) {
  return (
    <>
      <SiteHeader />
