...
import { contact, studio } from "@/lib/site/content"
      ...
      <Container>
        <div className="grid gap-20 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-5">
            ...
            <h1 className="site-h2 mt-8 text-balance">{contact.title}</h1>
            <p className="site-lead mt-10 max-w-[44ch] text-pretty text-muted-foreground">
              {contact.body}
            </p>
